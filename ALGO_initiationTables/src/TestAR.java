...
public class TestAR {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6 -> Tester la methode contientAuMoinsUnJoursDeGel()");
                     System.out.println();
            ...
            switch (choix) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    testcontientAuMoinsUnJoursDeGel();
                    break;
                default:
                    break;
            }
    ...
    private static void testcontientAuMoinsUnJoursDeGel() {
        int numTest;
        Temperatures temperatures;
        System.out.println();
        ...
        System.out.println(temperatures.toString());
        try {
            assertEquals("Test" + numTest + " ko", true, temperatures.contientAuMoinsUnJoursDeGel());
        }catch(ArrayIndexOutOfBoundsException e){
            System.out.println( "Test" + numTest + " ko : il y a eu sortie de table");
            e.printStackTrace();
            System.exit(0);
        ...
        System.out.println(temperatures.toString());
        try {
            assertEquals("Test" + numTest + " ko", false, temperatures.contientAuMoinsUnJoursDeGel());
        }catch(ArrayIndexOutOfBoundsException e){
            System.out.println( "Test" + numTest + " ko : il y a eu sortie de table");
            e.printStackTrace();
            System.exit(0);
