...
public class Questionnaire {
	...
	public QuestionCM fournirQuestion(){
		...
		int indiceQuestion = unEntierAuHasardEntre(0,nombreQuestionsRestantes-1);
		QuestionCM questionAFournir = tableQuestions[indiceQuestion];


		tableQuestions[indiceQuestion] = tableQuestions [nombreQuestionsRestantes-1];
		tableQuestions[nombreQuestionsRestantes-1] = questionAFournir;
