...
public class TriParComptage {
	...
	public static void triSelf (int[] t, int borneSup) {
		...
		// phase 2
		int iT = 0;
		for (int iTC = 0; iTC < tableComptage.length; iTC++) {
			// on recopie le nombre iTC autant de fois qu'on l'a compte
			for (int cpt = 0; cpt < tableComptage[iTC]; cpt++) {
				t[iT] = iTC;
				iT++;
			}
		}
   ...
   public static void triSelf (int[] t, int borneInf, int borneSup) {
	   ...
	   int[] temp = new int[borneSup - borneInf + 1];
